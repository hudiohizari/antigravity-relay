...
export function CloudAccountToolbar({
  ...
  return (
    <div className="bg-card flex flex-wrap items-center gap-2 rounded-lg border p-3">
      ...
      >
        <RefreshCcw
          className={`h-4 w-4 ${isForcePollPending ? "animate-spin" : ""}`}
        />
      </Button>
      ...
      <Dialog open={isExportDialogOpen} onOpenChange={onExportDialogOpenChange}>
        ...
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              {t("cloud.exportImport.exportDesc")}
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isImportDialogOpen} onOpenChange={onImportDialogOpenChange}>
        ...
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              {t("cloud.exportImport.importDesc")}
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Select
                ...
                onValueChange={onImportStrategyChange}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="merge">
                    {t("cloud.exportImport.strategyMerge")}
                  </SelectItem>
          ...
          <DialogFooter>
            <Button
              onClick={onImport}
              disabled={!importFileContent || isImportPending}
            >
              {isImportPending && (
                <Loader2 className="mr-2 h-4 w-4 animate-spin" />
              )}
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                disabled={
                  isOAuthClientsLoading || isSetActiveOAuthClientPending
                }
              >
      ...
      <AccountTierFilterDropdown
        ...
        getOptionLabel={(option) =>
          getTierOptionLabel(option.key, option.label)
        }
