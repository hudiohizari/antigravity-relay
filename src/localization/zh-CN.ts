const zhCn = {
  ...
  context: {
    title: "对话上下文遥测",
    subtitle: "实时监控上下文窗口使用量、内存压力与压缩状态",
    badge_live: "进行中",
    badge_idle: "空闲",
    badge_not_detected: "未检测到 Antigravity",
    status_normal: "正常",
    status_high_pressure: "高负荷",
    status_critical: "严重压缩风险",
    pressure_normal: "正常",
    pressure_high: "高负荷",
    pressure_critical: "严重压缩风险",
    metric_used: "已用令牌",
    metric_max: "上下文上限",
    metric_ratio: "上下文窗口使用率",
    tokens_unit: "令牌",
    cached_tokens: "提示词缓存",
    input_tokens: "输入令牌",
    fresh_input_tokens: "新增输入",
    completion_tokens: "补全令牌",
    thinking_tokens: "思考令牌",
    output_tokens: "输出令牌",
    active_session_title: "当前 Cascade 会话",
    workspace_label: "工作区",
    session_id_label: "会话 ID",
    copy_session_id: "复制会话 ID",
    session_id_copied: "会话 ID 已复制到剪贴板",
    step_count: "已完成 {{count}} 轮",
    last_updated: "更新于 {{time}}",
    subagents_title: "活跃子代理",
    subagents_active_count: "{{count}} 个活跃",
    subagents_total_tokens: "{{count}} 令牌",
    subagents_toggle_aria: "展开或折叠活跃子代理列表",
    subagent_role: "子代理角色",
    subagent_tokens: "{{count}} 令牌",
    switch_preview_title: "模型切换兼容性",
    switch_preview_subtitle: "预览当前对话在切换到其他模型时的适配情况",
    switch_fits: "充裕可用",
    switch_high_pressure: "内存压力较高",
    switch_overflow: "压缩风险: 超出限制 {{count}} 令牌",
    model_limit_estimated: "预估上限",
    model_limit_authoritative: "已验证上限",
    compaction_detected_title: "对话历史已在上游压缩",
    compaction_detected_desc:
      "为适应模型限制，对话历史已被压缩（{{time}} 减少 {{count}} 令牌）。",
    compaction_delta_pill: "-{{count}} 令牌",
    compaction_dismiss: "忽略提醒",
    empty_title: "无活跃对话",
    empty_desc:
      "在 Antigravity 中启动提示或 Cascade 即可实时查看上下文使用量与窗口上限。",
    empty_cta: "打开 Antigravity",
    error_title: "无法读取上下文遥测",
    error_desc: "无法从本地环境读取活跃会话状态。请检查 Antigravity 是否可用。",
    error_retry: "重试检查",
    loading_title: "正在读取活跃上下文...",
    loading_desc: "正在连接本地会话遥测...",
    concurrent_title: "并行会话",
    no_concurrent: "无其他活跃会话",
    stale_warning: "遥测数据可能会有轻微延迟",
    current_model: "当前",
    stale_badge: "过期",
    compacting_badge: "正在压缩上下文...",
    refreshing_label: "正在刷新上下文...",
  },
};
export default zhCn;
