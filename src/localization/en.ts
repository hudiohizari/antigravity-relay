const en = {
  ...
  context: {
    title: "Chat Context Telemetry",
    subtitle:
      "Real-time context window usage, memory pressure, and compaction monitoring",
    badge_live: "Live",
    badge_idle: "Idle",
    badge_not_detected: "Antigravity Not Detected",
    status_normal: "Normal",
    status_high_pressure: "High Pressure",
    status_critical: "Critical Compaction Risk",
    pressure_normal: "Normal",
    pressure_high: "High Pressure",
    pressure_critical: "Critical Compaction Risk",
    metric_used: "Used Tokens",
    metric_max: "Context Ceiling",
    metric_ratio: "Context Window Utilization",
    tokens_unit: "tokens",
    ...
    active_session_title: "Active Cascade Session",
    workspace_label: "Workspace",
    session_id_label: "Session ID",
    copy_session_id: "Copy Session ID",
    session_id_copied: "Session ID copied to clipboard",
    step_count: "{{count}} turns completed",
    last_updated: "Updated {{time}}",
    subagents_title: "Active Subagents",
    subagents_active_count: "{{count}} active",
    subagents_total_tokens: "{{count}} tokens",
    subagents_toggle_aria: "Toggle active subagents list",
    subagent_role: "Subagent Role",
    subagent_tokens: "{{count}} tokens",
    switch_preview_title: "Model Switch Compatibility",
    switch_preview_subtitle:
      "Preview how your current conversation fits into alternative model context windows",
    switch_fits: "Fits Comfortably",
    switch_high_pressure: "High Memory Pressure",
    switch_overflow: "Compaction Risk: Exceeds limit by {{count}} tokens",
    model_limit_estimated: "Estimated Limit",
    model_limit_authoritative: "Verified Limit",
    compaction_detected_title: "Conversation Compacted Upstream",
    compaction_detected_desc:
      "Conversation history was compressed to fit within model limits (-{{count}} tokens at {{time}}).",
    compaction_delta_pill: "-{{count}} tokens",
    compaction_dismiss: "Dismiss Alert",
    empty_title: "No Active Conversation",
    empty_desc:
      "Start a prompt or cascade in Antigravity to view live context usage and window limits in real time.",
    empty_cta: "Open Antigravity",
    error_title: "Unable to Inspect Context Telemetry",
    error_desc:
      "Could not read active session state from your local environment. Check if Antigravity is accessible.",
    error_retry: "Retry Inspection",
    loading_title: "Reading Active Context...",
    loading_desc: "Connecting to local session telemetry...",
    concurrent_title: "Concurrent Sessions",
    no_concurrent: "No other active sessions",
    stale_warning: "Telemetry data may be momentarily delayed",
    current_model: "Current",
    stale_badge: "Stale",
    compacting_badge: "Context compacting...",
    refreshing_label: "Refreshing context...",
  },
};
export default en;
