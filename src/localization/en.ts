const en = {
  ...
  relay: {
    ...
    upstreamConnected: "Connected to Daemon",
    upstreamReconnecting: "Reconnecting to Daemon...",
    upstreamBuffering: "Buffering (Daemon Restarting)",
    upstreamOffline: "Daemon Offline",
