const id = {
  ...
  sessions: {
    ...
    activeCountRatio: "{{active}} dari {{total}} aktif",
    activeCountAria: "{{count}} sesi aktif dari {{total}} terdaftar",
    ...
    statusBadgeLabel: "Status koneksi: {{status}}",
  ...
  settings: {
    ...
    examples: {
      ...
      description: "Contoh perintah untuk memanggil proksi API lokal.",
      curl: "cURL",
      python: "Python",
      copy: "Salin",
      copied: "Tersalin!",
      openai_protocol: "Protokol OpenAI",
      anthropic_protocol: "Protokol Anthropic",
      openai_tools: "Cursor, Windsurf, NextChat",
      anthropic_tools: "Claude Code CLI",
      flash: "Cepat",
      pro: "Pro",
      flash_preview: "Pratinjau",
      pro_high: "Terbaik",
      sonnet: "Berpikir",
      opus: "Opus",
    },
    gateway: {
      title: "Layanan Proksi API",
      description: "Kontrol server proksi API lokal.",
      status_running: "Berjalan",
      status_stopped: "Berhenti",
      action_start: "Mulai Layanan",
      action_stop: "Hentikan Layanan",
      accounts_info: "{{count}} akun tersedia",
      port: "Port Dengar",
      port_hint: "Default 8045, perlu mulai ulang untuk menerapkan perubahan",
      timeout: "Batas Waktu Permintaan",
      timeout_hint: "Default 120 detik, rentang 30-600 detik",
      api_key: "Kunci API",
      regenerate_key: "Buat Ulang",
      regenerateConfirm: {
        title: "Buat Ulang Kunci API?",
        description:
          "Ini akan segera membatalkan kunci API saat ini. Setiap aplikasi yang menggunakan kunci lama akan berhenti bekerja.",
        cancel: "Batal",
        confirm: "Buat Ulang",
      },
      key_warning:
  ...
  proxy: {
    title: "Proksi API",
    description: "Kelola layanan proksi API lokal.",
    save: "Simpan Pengaturan",
    copy: "Salin",
    copied: "Tersalin!",
    ...
    service: {
      ...
      start_failed: "Gagal memulai layanan",
      port_in_use_title: "Port sudah digunakan",
      port_in_use_description:
        "Port {{port}} sudah digunakan oleh proses lain. Tutup proses tersebut, atau ubah port dengar proksi API di Pengaturan lalu coba lagi.",
    },
    config: {
      port: "Port Dengar",
      timeout: "Batas Waktu Permintaan",
      ...
      auto_start: "Mulai Otomatis bersama Aplikasi",
      auto_start_desc: "Mulai layanan proksi saat aplikasi diluncurkan",
      cloud_code_meta: "Metadata Cloud Code",
    ...
    mapping: {
      title: "Pemetaan Model",
      description: "Petakan model Claude ke model Gemini untuk perutean.",
      maps_to: "Dipetakan ke",
      restore: "Pulihkan Default",
      "only-raw-quota-models": "Hanya tampilkan model kuota",
      "only-raw-quota-models-desc":
        "API daftar model hanya mengembalikan model fisik yang ditemukan dari cache kuota akun yang terhubung.",
    },
    "open-code": {
      title: "Sinkronisasi OpenCode",
      description:
        "Sinkronkan penyedia terkelola tanpa menulis ulang komentar atau format JSONC yang dikelola manual.",
      synced: "Tersinkronkan",
      "synced-custom-url": "Tersinkronkan dengan URL kustom",
      "not-synced": "Tidak tersinkronkan",
      "config-path": "Konfigurasi",
      "configured-models": "Model yang dikonfigurasi",
      runtime: "Runtime OpenCode",
      installed: "Terpasang",
      "not-installed": "Tidak terdeteksi",
      credential: "Kredensial khusus",
      "key-stored": "Tersimpan di brankas kredensial sistem operasi",
      "key-missing": "Dibuat pada sinkronisasi berikutnya",
      "backup-notice":
        "Cadangan mempertahankan komentar dan pemformatan. Kredensial diganti dengan placeholder tidak valid dan kunci saat ini disuntikkan saat pemulihan.",
      sync: "Konfigurasikan dan sinkronkan OpenCode",
      restore: "Pulihkan cadangan",
      clear: "Hapus konfigurasi terkelola",
      revoke: "Cabut kunci khusus",
      "model-dialog-title": "Pilih model OpenCode",
      "model-dialog-description":
        "Model yang dipilih akan ditambahkan atau diperbarui. Model lama yang tidak dipilih tidak akan dihapus.",
      "custom-base-url": "BaseURL Relay Kustom",
      "reset-base-url": "Atur Ulang",
      "invalid-base-url": "Masukkan URL HTTP atau HTTPS yang valid.",
      "sync-accounts": "Sinkronkan akun ke antigravity-accounts.json",
      "sync-accounts-description":
        "OpenCode memerlukan token penyegaran di file plugin lokalnya. Opsi ini dinonaktifkan secara default; token tidak pernah melintasi respons IPC renderer atau log.",
      "select-models": "Model untuk ditambahkan atau diperbarui",
      "selected-count": "{{selected}} dari {{total}} dipilih",
      "select-all": "Pilih semua",
      "deselect-all": "Batalkan semua pilihan",
      "confirm-sync": "Konfirmasi sinkronisasi",
      "auth-plugin-warning-title": "Plugin autentikasi lama terdeteksi",
      "auth-plugin-warning-description":
        "opencode-antigravity-auth dapat berkonflik dengan penyedia terkelola. Tinjau plugin sebelum mengandalkan konfigurasi ini.",
      "view-config": "Lihat konfigurasi",
      "restore-confirm-title": "Pulihkan cadangan OpenCode?",
      "restore-confirm-description":
        "Ini menggantikan konfigurasi OpenCode yang aktif dengan cadangan satu kali. Cadangan akan digunakan setelah pemulihan berhasil.",
      "confirm-restore": "Konfirmasi pemulihan",
      "clear-confirm-title": "Hapus konfigurasi OpenCode terkelola?",
      "clear-confirm-description":
        "Ini menghapus penyedia terkelola, mencocokkan entri Google dan Anthropic lama, dan kunci khusus. Pengaturan yang tidak terkait tetap tidak berubah, dan cadangan yang disamarkan masih dapat dipulihkan.",
      "confirm-clear": "Konfirmasi penghapusan",
      "config-viewer-title": "Konfigurasi OpenCode",
      "config-viewer-description": "Pratinjau konfigurasi hanya-baca",
      "config-redacted-notice":
        "Komentar dihilangkan dan bidang sensitif disamarkan sebelum pratinjau ini mencapai renderer.",
      "config-copied": "Konfigurasi yang disamarkan berhasil disalin",
      "config-copy-failed": "Gagal menyalin konfigurasi",
      "config-load-failed": "Gagal memuat konfigurasi",
      "copy-config": "Salin konfigurasi yang disamarkan",
      "success-title": "Konfigurasi OpenCode diperbarui",
      "error-title": "Pembaruan OpenCode gagal",
      "unknown-error": "Kesalahan konfigurasi OpenCode tidak diketahui",
    },
    examples: {
      title: "Contoh Penggunaan",
      description: "Contoh perintah untuk memanggil proksi API lokal.",
