const vi = {
  ...
  sessions: {
    ...
    activeCountRatio: "{{active}} trên {{total}} đang hoạt động",
    activeCountAria: "{{count}} phiên hoạt động trên {{total}} đã đăng ký",
    colDevice: "Thiết bị / Ứng dụng khách",
    colIp: "Địa chỉ IP",
    colDuration: "Đã kết nối",
    colLastActive: "Hoạt động gần nhất",
    colActions: "Thao tác",
    statusConnected: "Hoạt động",
    statusDisconnected: "Đã ngắt kết nối",
    statusBadgeLabel: "Trạng thái kết nối: {{status}}",
