import { getPlatform } from '@/modules/app-shell/actions/app';
import { closeWindow, maximizeWindow, minimizeWindow } from '@/modules/app-shell/actions/window';
  ...
  useEffect(() => {
    ...
    getPlatform()
      ...
      .catch((error: unknown) => {
        ...
        logger.error('Failed to detect platform', failure);
      });
